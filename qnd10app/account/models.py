...
class Contact_Profile(models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    provincia =  models.CharField(max_length=200,null=True,blank=True, default='Pichincha') 
    canton = models.CharField(max_length=200,null=True,blank=True)
    parroquia = models.CharField(max_length=200,null=True,blank=True)
   
    direccion = models.CharField( max_length=200,null=True,blank=True)
    georeferencia = models.CharField( max_length=500,null=True,blank=True)
    telefono = PhoneNumberField(null=True,blank=True)
    social = models.URLField(null=True,blank=True)
    canton1 = models.CharField(max_length=200,null=True,blank=True)
    parroquia1 = models.CharField(max_length=200,null=True,blank=True)
...
class activity(models.Model):
    ...
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    diciplina = models.CharField(max_length=200,null=True, blank=True, verbose_name = "¿EN QUÉ DISCIPLINA/S ARTÍSTCA/S ENMARCA SUS ACTIVIDADES?")
    experiencia= RichTextField( verbose_name = "DESCRIBA DE MANERA SUCINTA SU EXPERIENCIA EN EL ÁMBITO CULTURAL")
    cv = models.ImageField(upload_to='users/%Y/%m/%d/', null=True, blank=True, verbose_name = "Adjunte su curriculum vitale")
    ...
    agremiacion = models.BooleanField(default=False, null=True, blank=True, verbose_name = "¿PERTENECE A ALGUNA AGREMIACIÓN / COLECTIVO ?") 
    nombre_agremiacion = models.CharField(max_length=200,null=True, blank=True, verbose_name = "Si pertenece a una agremiación o colectivo, escriba el nombre")
...
class Manual_lineasfomento_editorial(models.Model):
    introduccion =  RichTextField( verbose_name = "Introducción")
    paso1 =  RichTextField( verbose_name = "caracteristicas del app de inscripciones")
    paso2 =  RichTextField( verbose_name = "paso1- informacion de usuario ")
    paso3 =  RichTextField( verbose_name = "paso2 -informacion de contacto")
...
class Manual_creacion_convocatoria_fomento(models.Model):
    introduccion =  RichTextField( verbose_name = "Introducción")
    paso1 =  RichTextField( verbose_name = "caracteristicas del app de inscripciones")
    paso2 =  RichTextField( verbose_name = "paso1- informacion de usuario ")
    paso3 =  RichTextField( verbose_name = "paso2 -informacion de contacto")
...
class Manual_editar_convocatoria_fomento(models.Model):
    introduccion =  RichTextField( verbose_name = "Introducción")
    paso1 =  RichTextField( verbose_name = "caracteristicas del app de inscripciones")
    paso2 =  RichTextField( verbose_name = "paso1- informacion de usuario ")
    paso3 =  RichTextField( verbose_name = "paso2 -informacion de contacto")
...
class Manual_editar_configuracion(models.Model):
    introduccion =  RichTextField( verbose_name = "Introducción")
    paso1 =  RichTextField( verbose_name = "caracteristicas del app de inscripciones")
    paso2 =  RichTextField( verbose_name = "paso1- informacion de usuario ")
    paso3 =  RichTextField( verbose_name = "paso2 -informacion de contacto")
