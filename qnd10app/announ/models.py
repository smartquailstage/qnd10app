...
class announ_linea_fomento_editorial(models.Model):
    ...
    horas_diferencia = models.IntegerField(default=0)
    minutos_diferencia = models.IntegerField(default=0)
    segundos_diferencia = models.IntegerField(default=0)
    dias_diferencia_activacion = models.IntegerField(default=0)
    horas_diferencia_activacion = models.IntegerField(default=0)
    minutos_diferencia_activacion = models.IntegerField(default=0)
    segundos_diferencia_activacion = models.IntegerField(default=0)
