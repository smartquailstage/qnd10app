...
urlpatterns = [
    ...
    path('<pk>/module/biblio/', views.ProjectBibliographicReferenceUpdateView.as_view(), name='project_biblio_update'),
    path('<pk>/module/plan_de_trabajo/', views.WorkPlanUpdateView.as_view(), name='project_work_plan_update'),
