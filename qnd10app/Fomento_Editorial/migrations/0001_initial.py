...
import Fomento_Editorial.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', Fomento_Editorial.fields.OrderField(blank=True)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='Fomento_Editorial.course')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.AddField(
            model_name='course',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='Fomento_Editorial.subject'),
        ),
        migrations.CreateModel(
            name='Content',
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='Fomento_Editorial.module')),
            ],
            options={
                'ordering': ['order'],
            },
